...
function preload() {
    fundoImg = loadImage('./img/fundo1.png');
    bolaImg = loadImage('./img/bola.png');
    barra1Img = loadImage('./img/barra01.png');
    barra2Img = loadImage('./img/barra02.png');
    bounceSound = loadSound('./audio/bounce.wav');
    golSound = loadSound('./audio/jingle_win.wav');
}
